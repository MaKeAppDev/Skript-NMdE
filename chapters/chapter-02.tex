...
\section{Matrix- und Vektornormen}
...
\subsection{Matrixnormen $(A\in\mathbb{R}^{n\times n})$}
\begin{tabular}{r@{ = }ll}
...
\subsection{Kompatibilität zwischen Vektor und Matrixnorm}
...
\subsection{Lagrange Interpolationspolynom}
\begin{equation}
...
\subsection{Dividierte Differenzen} Sei $P(x)$ das Lagrange-Polynom $n$-ter Ordnung. Wähle
\begin{equation}
